 ...
 *  com.generalsentiment.thirdparty.api.GetInvolvementExample
 *
 */
...
public class GetInvolvementExample {
    ...
    private static final String PROTECTED_RESOURCE_URL = "http://api.generalsentiment.com/api/getInvolvement";
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        System.out.println("POST /api/getInvolvement : ");
        OAuthRequest request2 = new OAuthRequest(Verb.POST, PROTECTED_RESOURCE_URL);

        request2.addBodyParameter("synsets", "Google\tgoogle\tGOOG\nMicrosoft\tMS\tMSFT\nObama\tBarack " +
            "Obama\tPresident Obama");
        request2.addBodyParameter("start_date", "20130401");
        request2.addBodyParameter("end_date", "20130501");
        request2.addBodyParameter("max_entity", "USA");
        request2.addBodyParameter("news_weight", "10");
        request2.addBodyParameter("twitter_weight", "2");
        request2.addBodyParameter("social_weight", "3");
        request2.addBodyParameter("websites_weight", "4");
        request2.addBodyParameter("positive_mentions_markup", "0.75");
        request2.addBodyParameter("exposure_weight", "0.8");
        request2.addBodyParameter("scaling_factor", "20.0");

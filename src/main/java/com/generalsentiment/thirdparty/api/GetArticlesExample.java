 ...
 *  com.generalsentiment.thirdparty.api.GetArticlesExample
 *
 */
...
public class GetArticlesExample {
    ...
    private static final String PROTECTED_RESOURCE_URL = "http://api.generalsentiment.com/api/getArticles";
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        System.out.println("POST /api/getArticles : ");
        ...
        request2.addBodyParameter("max_articles", "75");

 ...
 *  com.generalsentiment.thirdparty.api.GetVolumeExample
 *
 */
...
public class GetVolumeExample {
    ...
    private static final String PROTECTED_RESOURCE_URL = "http://api.generalsentiment.com/api/getVolume";
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        System.out.println("POST /api/getVolume : ");
        ...
        request2.addBodyParameter("use_src_id_list", "true");
        request2.addBodyParameter("src_id_list", "1010014,1010052");
        // facebook.com , blogspot.com respectively as sources. Available to all API users.

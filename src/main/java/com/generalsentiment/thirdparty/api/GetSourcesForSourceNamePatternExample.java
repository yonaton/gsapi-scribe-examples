 ...
 *  com.generalsentiment.thirdparty.api.GetSourcesForSourceNamePatternExample
 *
 */
...
public class GetSourcesForSourceNamePatternExample {
    ...
    private static final String PROTECTED_RESOURCE_URL = "http://api.generalsentiment.com/api/getSourcesForSourceNamePattern";
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        System.out.println("POST /api/getSourcesForSourceNamePattern : ");
        OAuthRequest request2 = new OAuthRequest(Verb.POST, PROTECTED_RESOURCE_URL);

        request2.addBodyParameter("src_name_pattern", "media");

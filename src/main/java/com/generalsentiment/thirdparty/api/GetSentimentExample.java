 ...
 *  com.generalsentiment.thirdparty.api.GetSentimentExample
 *
 */
...
public class GetSentimentExample {
    ...
    private static final String PROTECTED_RESOURCE_URL = "http://api.generalsentiment.com/api/getSentiment";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("POST /api/getSentiment : ");
        ...
        request2.addBodyParameter("time_unit", "day");
        request2.addBodyParameter("depository", "twitter");
        request2.addBodyParameter("aggregate_sources", "true");
        request2.addBodyParameter("include_reference_polarity_count", "true");
        request2.addBodyParameter("smooth_sentiment", "true");

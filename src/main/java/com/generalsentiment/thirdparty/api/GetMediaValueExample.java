 ...
 *  com.generalsentiment.thirdparty.api.GetMediaValueExample
 *
 */
...
public class GetMediaValueExample {
    ...
    private static final String PROTECTED_RESOURCE_URL = "http://api.generalsentiment.com/api/getMediaValue";
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        System.out.println("POST /api/getMediaValue : ");
        ...
        request2.addBodyParameter("start_date", "20130401");
        request2.addBodyParameter("end_date", "20130501");
        request2.addBodyParameter("depository", "main");
        request2.addBodyParameter("src_group_id", "8af08ee83659be21013659e2a5ff16a6");
        /*
         * The "Social Media" CATEGORY source-group , consisting of all social-media sources.
         * Available to all API users.
         */
        request2.addBodyParameter("mv_type", "custom");
        request2.addBodyParameter("mv_positive_ref_weight", "0.7");
        request2.addBodyParameter("mv_negative_ref_weight", "-0.6");
        request2.addBodyParameter("mv_neutral_ref_weight", "0.5");
        request2.addBodyParameter("mv_per_news_ref", "0.005");
        request2.addBodyParameter("mv_per_twitter_ref", "0.0005");
        request2.addBodyParameter("mv_per_non_twitter_social_media_ref", "0.001");
        request2.addBodyParameter("mv_per_misc_entry_in_main_depository", "0.0005");
        request2.addBodyParameter("mv_per_misc_entry_in_flexworld_depository", "0.001");
